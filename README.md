# Takyly
[![Build Status](https://travis-ci.org/takyly/takyly-web.svg?branch=master)](https://travis-ci.org/takyly/takyly-web)
...
To optimize the Takyly application for production, run:
